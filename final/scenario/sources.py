...
SOURCES = [
    ...
    dict(key="incheon", name="인천시 누리집", status=OK,
         ...
         search=None,
         gives=["사람", "기술", "돈", "팔 곳", "받쳐 줄 기업", "공간·장비"],
    ...
    dict(key="data", name="공공데이터포털", status=OK,
         ...
         search=None,
         gives=["사람", "기술", "돈", "팔 곳", "받쳐 줄 기업", "공간·장비", "행정"],
...
CLAIM_TEXTS = {
    "돈": "○○년도 {industry} 분야 세부사업 예산 심사 과정의 증액·감액 사유서",
    "행정": "{industry} 분야 신규사업 유사·중복 검토서 및 부서 협의 요청서",
    "사람": "{industry} 분야 인력양성 사업의 수료·취업 실적 및 기업 수요조사서",
}
